# **Gradient Boost Tree (Train Validation Split) in PySpark**
...
gbttv_evaluator = RegressionEvaluator(predictionCol="prediction",labelCol="price",metricName="r2")

print("R Squared (R2) on test data = %g" %gbttv_evaluator.evaluate(prediction))

gbttv_evaluator = RegressionEvaluator(labelCol="price",predictionCol="prediction", metricName="rmse")
